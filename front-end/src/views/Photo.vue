  ...
  <div class="photo-page">
    <div class="image" v-if="photo != null">
      ...
      <div class="photoInfo">
        ...
        <p class="photoName" v-if="photoUser != null">
    ...
    <div class="comments">
      <p>Comments</p>
      <hr />
      <p v-if="commentArray.length === 0" style="text-align: center;">
        Comments have yet to be posted for this photo.
      </p>
      <div
        class="display-comments"
        v-for="c in commentArray"
        v-bind:key="c._id"
      >
        <div class="comment-name-date">
          ...
          <p>commented {{ formatDate(c.created) }}</p>
        </div>
